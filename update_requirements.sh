...
pip-compile --upgrade --allow-unsafe --resolver=backtracking -o requirements.txt requirements.in dev-requirements.in || { echo "Pip compile failed. This might happen due low memory. Please check requirements.in and dev-requirements.in files. "; exit 1; }
